...
public class SinglePlay2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_play2);
        occupied_space=new ArrayList<Integer>();
        random=new Random();
        t1=findViewById(R.id.text3b);
        t2=findViewById(R.id.text4b);
        t3=findViewById(R.id.text5b);
        t4=findViewById(R.id.text6b);
        t5=findViewById(R.id.text7b);
        t6=findViewById(R.id.text8b);
        t7=findViewById(R.id.text9b);
        t8=findViewById(R.id.text10b);
        t9=findViewById(R.id.text11b);
        scoreV=findViewById(R.id.scoreb);
        displayResult();
...
//        Log.i("akm", "clickStart: "+getVacantLine(1));
    ...
    public void click1(View view) {
        ...
        TextView tv=findViewById(R.id.text3b);
        ...
        if (t1.getText().toString().equals(t2.getText().toString()) && t2.getText().toString().equals(t3.getText().toString()) && (t3.getText().toString().equals("X") || t3.getText().toString().equals("O"))) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent in=new Intent(getApplicationContext(),SinglePlay.class);
...
//        builder.create().show();
    ...
    public void click2(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text4b);
    ...
    public void click3(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text5b);
        // tv.setClickable(false);
        tv.setOnClickListener(null);
    }
    ...
    public void click4(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text6b);
        //tv.setClickable(false);
        tv.setOnClickListener(null);
    ...
    public void click9(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text11b);
        // tv.setClickable(false);
        tv.setOnClickListener(null);
    }
    ...
    public void click6(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text8b);
        //tv.setClickable(false);
        tv.setOnClickListener(null);
    }
    ...
    public void click5(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text7b);
        tv.setClickable(false);
        // tv.setOnClickListener(null);
    }
    ...
    public void click7(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text9b);
        tv.setClickable(false);
        // tv.setOnClickListener(null);
    }
    ...
    public void click8(View view) {
        ...
        clickStart(click_value);
        TextView tv=findViewById(R.id.text10b);
        tv.setClickable(false);
        // tv.setOnClickListener(null);
    }
}